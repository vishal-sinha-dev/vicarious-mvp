    ...
    <main>
        ...
        >
            <article class="prose max-w-none">
                <h1>Privacy Policy of Vicarious</h1>

                <p>
                    Vicarious operates the {{ $app_url }} website, which
                ...
                <p>
                    ...
                    {{ $app_url }}, unless otherwise defined in this
                    Privacy Policy.
                </p>
                ...
                <p>
                    ...
                    Policy, do not hesitate to contact us at <a href="{{ $app_url }}/contact">{{ $app_url }}/contact</a>.
                </p>
            </article>
        </section>
    </main>
